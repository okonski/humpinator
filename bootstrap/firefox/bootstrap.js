...
function setupComponent(installPath, name){
	try {		
		var jsFile = installPath.clone();
		jsFile.append("components");
		jsFile.append(name + ".js");
		var path = ios.newFileURI(jsFile).spec;
		var scope = {};
...
function startup(data, reason){
	if (!gHarness) {
		...
		setupComponent(data.installPath, "about");
		setupComponent(data.installPath, "extension-protocol");
	}	
}
